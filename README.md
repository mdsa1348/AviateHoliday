...
i.Downloading any part of the repository.
ii.Cloning the repository for personal or public use.
iii.Modifying or using the code in any other project or for any purpose without explicit written permission.
